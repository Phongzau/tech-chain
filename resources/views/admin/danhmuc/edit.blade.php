                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="hinh_anh" onchange="showImage(event)"
                                            class="form-control">
                                        <img src="{{ Storage::url($danhMuc->hinh_anh) }}" id="img_danh_muc"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-10 mb-3 d-flex gap-2">
                                    <div class="form-check">
                                        <input {{ $danhMuc->trang_thai == true ? 'checked' : '' }} class="form-check-input"
                                            type="radio" name="trang_thai" id="trang_thai" value="1">
                                        <label class="form-check-label" for="gridRadios1">
                                            Hiển thị
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input {{ $danhMuc->trang_thai == false ? 'checked' : '' }} class="form-check-input"
                                            type="radio" name="trang_thai" id="trang_thai" value="0">
