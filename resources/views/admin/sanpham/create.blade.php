                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="ma_san_pham" name="ma_san_pham"
                                            ...
                                            placeholder="Nhập tên danh mục" value="{{ old('ma_san_pham') }}">
                                        @error('ma_san_pham')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="ten_san_pham" name="ten_san_pham"
                                            ...
                                            placeholder="Nhập tên danh mục" value="{{ old('ten_san_pham') }}">
                                        @error('ten_san_pham')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="gia_san_pham" name="gia_san_pham"
                                            ...
                                            placeholder="Nhập tên danh mục" value="{{ old('gia_san_pham') }}">
                                        @error('gia_san_pham')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="gia_khuyen_mai" name="gia_khuyen_mai"
                                            ...
                                            placeholder="Nhập tên danh mục" value="{{ old('gia_khuyen_mai') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="so_luong" name="so_luong"
                                            ...
                                            placeholder="Nhập tên danh mục" value="{{ old('so_luong') }}">
                                        @error('so_luong')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" id="ngay_nhap" name="ngay_nhap"
                                            ...
                                            placeholder="Nhập tên danh mục" value="{{ old('ngay_nhap') }}">
                                        @error('ngay_nhap')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="mo_ta_ngan" id="mo_ta_ngan" class="form-control @error('ngay_nhap') is-invaild  @enderror"
                                            rows="3">{{ old('mo_ta_ngan') }}</textarea>
                                        @error('ngay_nhap')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="col-sm-10 mb-3 d-flex gap-2">
                                            <div class="form-check">
                                                <input {{ old('is_type') == 1 ? 'checked' : '' }} class="form-check-input"
                                                    type="radio" name="is_type" id="is_type" value="1">
                                                <label class="form-check-label" for="gridRadios1">
                                                    Hiển thị
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input {{ old('is_type') == 0 ? 'checked' : '' }} class="form-check-input"
                                                    type="radio" name="is_type" id="is_type" value="0">
                                    ...
                                    <div class="form-switch ps-3 mb-2 d-flex justify-content-between">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input btn-secondary" type="checkbox" name="is_hot"
                                                checked>
                                            <label class="form-check-label" for="flexSwitchCheckChecked">Hot</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input bg-warning" type="checkbox" name="is_hot_deal"
                                                checked>
                                ...
                                <div class="col-lg-8">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="noi_dung" id="noi_dung_content" class="d-none">{{ old('noi_dung') }}</textarea>
                                    </div>
                                            ...
                                            <tbody id="image-table-body">
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img id="preview_0"
                                                            src="https://www.pikpng.com/pngl/m/74-745720_download-img-icon-png-clipart.png"
