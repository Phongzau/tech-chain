                                ...
                                <table class="table table-striped mb-0">
                                    ...
                                    <tbody>
                                        @foreach ($listDonHang as $item)
                                            <tr>
                                                <th>
                                                    <a href="{{ route('admin.don-hang.show', $item->id) }}">
                                                        {{ $item->ma_don_hang }}
                                                    </a>
                                                </th>
                                                <td>
                                                ...
                                                <td>
                                                    <form action="{{ route('admin.don-hang.update', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
